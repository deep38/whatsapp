...
class UserTable {
  ...
  Future<int> update(Map<String, dynamic> data) async {
    return await db
        .update(_table, data, where: _wherId, whereArgs: [data['uid']]);
  }
  ...
  Future<int> updatePhotoUrl(String id, String photoUrl) async {
    return await db.update(
        _table,
        {
  ...
  Future<int> deleteUser(String id) async {
    return db.delete(_table, where: _wherId, whereArgs: [id]);
  }
